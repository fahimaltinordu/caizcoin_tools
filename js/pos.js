...
const CaizContract = "0xaebbd7b2eb03f84126f6849753b809755d7532f9";
...
// The Contract object
const TokenContract = new ethers.Contract(CaizContract, CaizAbi, provider);
	...
	var receipt = $('#usdamount').val();	
		if (receipt != '' && receipt != 0) {
			  ...
			  document.querySelector(".form--result").innerHTML = `
					  <div id="sonuc2">
						  <div>
							<img draggable="false" src="img/caiz.gif" width="100" height="100" alt="Loading QR">
				...
				$("#check").click(function() {
					...
					TokenContract.on(filter, (from, to, amount, event) => {  
							...
							if (finalreceived == amountinwilc) {
								...
								$("#confirm7").html(txid);
								$("#confirm8").html(amountinwilc + " <b>CAIZ</b>");
								$("#confirm9").html(finalreceived + " <b>CAIZ</b>");
								...
								$("#confirm1").html(finalreceived + " <b>CAIZ</b>");
								$("#confirm2").html(sender);
								$("#confirm3").html(txid);
								$("#confirm4").html(missing + " <b>CAIZ</b>");
								$("#confirm5").html(amountinwilc + " <b>CAIZ</b>");
								...
								$("#confirm100").html(finalreceived + " <b>CAIZ</b>");
								$("#confirm200").html(sender);
								$("#confirm300").html(txid);
								$("#confirm400").html(extraamount + " <b>CAIZ</b>");
								$("#confirm500").html(amountinwilc + " <b>CAIZ</b>");
